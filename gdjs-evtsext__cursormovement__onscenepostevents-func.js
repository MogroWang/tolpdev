...
{
{runtimeScene.getScene().getVariables().get("__mousemovement").getChild("MousePreX").setNumber(gdjs.evtTools.input.getCursorX(runtimeScene, "Cursor", 0));
}{runtimeScene.getScene().getVariables().get("__mousemovement").getChild("MousePreY").setNumber(gdjs.evtTools.input.getCursorY(runtimeScene, "Cursor", 0));
}}
