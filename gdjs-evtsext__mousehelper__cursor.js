...
{for(var i = 0, len = gdjs.evtsExt__MouseHelper__cursor.cursor.prototype.doStepPreEventsContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__MouseHelper__cursor.cursor.prototype.doStepPreEventsContext.GDObjectObjects1[i].setPosition(gdjs.evtTools.input.getCursorX(runtimeScene, "Cursor", 0),gdjs.evtTools.input.getCursorY(runtimeScene, "Cursor", 0));
}
}}
